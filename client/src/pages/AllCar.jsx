    ...
    <div className="bg-gray-900 min-h-screen text-white">
      ...
      <div className="max-w-4xl mx-auto py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {cars.map(car => (
            <div key={car._id} onClick={() => handleclick(car._id)} className="bg-black rounded-lg p-4 cursor-pointer hover:shadow-lg transition duration-300 ease-in-out">
              ...
              <div>
                <h3 className="text-xl font-semibold text-center">{car.brand}</h3>
