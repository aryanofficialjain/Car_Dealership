...
const CarList = () => {
  ...
  useEffect(() => {
    const fetchCars = async () => {
      try {
        const res = await axios.get('https://car-dealership-server-03td.onrender.com/car/allcars');
        setCars(res.data); 
      } catch (error) {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://car-dealership-server-03td.onrender.com/car/car/${id}`);
