...
const Cart = () => {
  ...
  const fetchCartItems = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_DOMAIN_URL}/cart/getitem`, {
        headers: {
  ...
  const handleBuy =  () => {
    ...
    //   const response = await axios.post("${import.meta.env.VITE_DOMAIN_URL}/cart/buy", { ids: carIds }, {
    //     headers: {
    //       Authorization: `Bearer ${token}`,
    //     },
    //   });
  ...
  const handleRemoveItem = async (id) => {
    try {
      await axios.delete(`${import.meta.env.VITE_DOMAIN_URL}/cart/deleteitem`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        data: { itemId: id },
